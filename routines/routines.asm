...
dzx7m_load_bits3_ev:
	...
	rl	c
	rl	b
	jr	nc, dzx7m_len_value_start_ev ; check end marker
dzx7m_exit_ev:
	pop	de
	ret
...
dzx7m_load_bits3_od:
	...
	rl	c
	rl	b
	jr	nc, dzx7m_len_value_start_od ; check end marker
dzx7m_exit_od:
	pop	de
	ret
...
LoadUnitDynamically:
	...
	ld	de, (BuildingsSpritesPtr)
	push	de
	call	dzx7_Mega					; HL = pointer to byte after uncompressed data
	pop	de
	or	a, a
	sbc	hl, de
	push	hl
